...
export function Card({ id, image, date, title, description, user, category }: Props) {
    return (
        <div id="card" className="my-5 flex">
            ...
            <div>
                <div className="mt-2 flex gap-1">
                    ...
                    <p className="rounded-xl bg-gray-200 px-2 py-2 text-[13px] text-gray-500">{category}</p>
                </div>
                ...
                <div className="border-gray-400 px-3.5 py-2.5 after:mx-auto after:my-6 after:block after:w-[70%] after:rounded-xl after:border-1 after:border-gray-200">
