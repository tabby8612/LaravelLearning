...
export default function posts({ data, token }: Props) {
    ...
    return (
        <DashboardLayout title="All Posts" identifier="posts">
            <div className="mx-12 my-12 w-6xl">
                ...
                <table className="table-cell border-2 border-gray-50 shadow-xl">
                    <thead className="bg-blue-100 text-xl">
                        <tr className="">
                            <th className="px-2.5">S.No</th>
                            <th className="px-2.5">Author</th>
                            <th className="px-2.5">Title</th>
                            <th className="px-2.5">Description</th>
                            <th className="px-2.5">Image</th>
